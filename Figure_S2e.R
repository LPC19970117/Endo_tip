...
frg2<- c("CA4","CD36","CD320","BTNL9","FABP5","PLVAP","TMEM88","SLC14A1")
...
exprTab$gene <- factor(exprTab$gene,
                       levels = rev(c("CA4","CD36","CD320","BTNL9","FABP5","PLVAP","TMEM88","SLC14A1")))
...
ggarrange(p_top,
          ...
          heights = c(2,6),
          common.legend = F)
ggsave("Figure 1B differential expression of interested genes in pancancer_cap.pdf", width = 6,height =3)
rm(expr); gc()
